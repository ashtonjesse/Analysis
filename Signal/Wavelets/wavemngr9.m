...
switch option
      ...
      if isempty(Wavelets_Info)
          try
              ...
              try
                  ...
                  disp('---------------------------------------------');
                  disp(' ');
                  Wavelets_Info  = wavemngr9('rescue');
              end
          end
      end
    ...
    case 'indw'
      ...
      % out6 = flag '**' (for GUI)
      %---------------------------
      if isempty(Wavelets_Info) , wavemngr9('load'); end
      nb_fam = size(Wavelets_Info,1);
      wname  = deblankl9(varargin{1});
      lwna   = length(wname);
      for i_fam=1:nb_fam
    ...
    case 'fields'
      ...
      switch in_type
          ...
          case 'fsn' , i_fam = wavemngr9('indf',arg);
          case 'wn'  , i_fam = wavemngr9('indw',arg);
      end
      nb = nargin-2;
      if nb==0
    ...
    case 'type'
        i_fam = wavemngr9('indw',varargin{1});
    ...
    case {'tabnums','tabNums'}
        i_fam = wavemngr9('indf',varargin{1});
    ...
    case 'fam_num'
        [nul,nul,varargout{1},varargout{2}] = wavemngr9('indw',varargin{1});

    case 'length'
        wname = varargin{1};
        [wtype,bounds] = wavemngr9('fields',{'wn',wname},'type','bounds');
        switch wtype
            case {1,2}
                Lo_D = wfilters(wname);
    ...
    case 'add'
        ...
        if err==0
            ...
            if isempty(family_Short_Name)
                ...
                fsnIn   = deblankl9(family_Short_Name);
        ...
        if err==0
            ...
            elseif findstr('.mat',wavelet_File)
                ...
                wavelet_File = deblankl9(wavelet_File);
