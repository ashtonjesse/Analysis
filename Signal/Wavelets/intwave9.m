...
wtype = wavemngr9('type',wname);
switch wtype
  case {1,3} , [phi,psi,xval] = wavefun9(wname,iter);
  case 2     , [phi1,psi1,phi2,psi2,xval] = wavefun9(wname,iter);
  case {4,5} , [psi,xval] = wavefun9(wname,iter);
end
