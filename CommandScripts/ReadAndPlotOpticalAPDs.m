...
set(get(oAxes,'title'), 'string', ['Average APD ' char(177) ' 1SD (ms) during Baroreflex test #5 29/10']);
...
set(get(oSDAxes,'title'), 'string', ['Standard deviation of APD during Baroreflex test #5 29/10']);