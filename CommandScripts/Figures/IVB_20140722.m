...
aFiles = {...
    ...
    'G:\PhD\Experiments\Auckland\InSituPrep\20140722\20140722baro012\Pressure.mat' ...
    };
% %load the data
...
oSubplotPanel.margin = [15 5 2 10];
oSubplotPanel(1).margin = [2 5 0 0];
oSubplotPanel(2).margin = [2 5 0 0];
...
%annotate
annotation('textbox',[0.24,0.9,0.1,0.1],'string','Baseline','fontsize',12,'fontweight','bold','edgecolor','none');
annotation('textbox',[0.64,0.9,0.1,0.1],'string','7 \muM IVB','fontsize',12,'fontweight','bold','edgecolor','none');


%% print figure
export_fig('D:\Users\jash042\Documents\PhD\Thesis\Figures\IVB_20140722.png','-png','-r600','-nocrop','-painters');
% print(oFigure,'D:\Users\jash042\Documents\PhD\Thesis\Figures\IVB_20140722.eps','-dpsc','-r600');