...
sFileSavePath = 'D:\Users\jash042\Documents\PhD\Thesis\Figures\Working\BaroData_#';
...
export_fig(strrep(sFileSavePath, '#', '1'),'-png','-r600','-nocrop')
...
export_fig(strrep(sFileSavePath, '#', '2'),'-png','-r600','-nocrop','-transparent','-painters');%
% % %crop the images
