...
sSubDir = [sBaseDir,'20140723baro003\'];

%% read in the optical entities
sAvOpticalFileName = [sSubDir,'baro003_3x3_1ms_7x_g10_LP100Hz-wave.mat'];
% oAvOptical = GetOpticalFromMATFile(Optical,sAvOpticalFileName);
sOpticalFileName = [sSubDir,'baro003_3x3_1ms_7x_g10_LP100Hz-waveEach.mat'];
...
dWidth = 17;
dHeight = 9;
sFileSavePath = 'C:\Users\jash042.UOA\Dropbox\Publications\2017\PacemakerUncoupling\Figures\BaroDataForAPFigure.png';
...
%plot time scale
hold(oAxes,'on');
plot([oXLim(1)+0.5; oXLim(1)+2.5], [oYLim(1)+2; oYLim(1)+2], '-k','LineWidth', 2)
hold(oAxes,'off');
...
for i = 1:yrange
    for j = 1:xrange
        ...
        %         oLabel = text(aXlim(1)-0.4,aYlim(1)+0.5,sprintf('%4.0f mmHg',round(oPressure.Processed.Data(MinIndex))),'parent',oAxes,'fontunits','points','HorizontalAlignment','left');
        %         set(oLabel,'fontsize',8);
    end
end
