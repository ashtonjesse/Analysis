...
dWidth = 16;
dHeight = 21.7;
sSavePath = 'D:\Users\jash042\Documents\PhD\Thesis\Figures\ExtracellularPacemakerShift_20140505.eps';
...
for i = 1:yrange
    for j = 1:xrange
        ...
        if (i == 1) && (j == 1)
            ...
            axis(oOverlay,'off');
            %create labels
            oLabel = text(2.2,6,'SVC','parent',oOverlay,'fontweight','bold','fontunits','points','HorizontalAlignment','left');
            set(oLabel,'fontsize',8);
            oLabel = text(0,0.3,'IVC','parent',oOverlay,'fontweight','bold','fontunits','points','HorizontalAlignment','right');
            set(oLabel,'fontsize',8);
            oLabel = text(4.2,0.5,'RA','parent',oOverlay,'fontweight','bold','fontunits','points','HorizontalAlignment','left');
            set(oLabel,'fontsize',8);
         else
