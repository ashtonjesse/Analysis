...
aFiles = {...
    'G:\PhD\Experiments\Auckland\InSituPrep\20140507\20140507baro003\baro003_pressure.mat' ...
    'G:\PhD\Experiments\Auckland\InSituPrep\20140507\20140507baro010\baro010_pressure.mat' ...
    'G:\PhD\Experiments\Auckland\InSituPrep\20140507\20140507baro012\baro012_pressure.mat' ...
    };
% % %load the data
...
%annotate
annotation('textbox',[0.12,0.9,0.1,0.1],'string','Baseline','fontsize',12,'fontweight','bold','edgecolor','none');
annotation('textbox',[0.46,0.9,0.1,0.1],'string','CsCl','fontsize',12,'fontweight','bold','edgecolor','none');
annotation('textbox',[0.76,0.9,0.1,0.1],'string','Washout','fontsize',12,'fontweight','bold','edgecolor','none');



%% print figure
export_fig('D:\Users\jash042\Documents\PhD\Thesis\Figures\CsCl_20140507.png','-png','-r600','-nocrop','-painters');
print(oFigure,'D:\Users\jash042\Documents\PhD\Thesis\Figures\CsCl_20140507.eps','-dpsc','-r600');