...
%             end
    ...
    save([pathstr,'\',upper(sStimulationType(1)),sStimulationType(2:end),'LocationData_20171222.mat'],'DPSites');
    fprintf('Saved %s\n\n', [pathstr,'\',upper(sStimulationType(1)),sStimulationType(2:end),'LocationData_20171222.mat']);
end
