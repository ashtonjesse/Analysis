...
%     aAllActivationTimes = zeros(40,41,length(sBeatFileName));
%     aAllRepolarisationTimes = zeros(40,41,length(sBeatFileName));
%     aAllAPDs = zeros(40,41,length(sBeatFileName));
%     %get the beat data
%     for i = 1:length(sBeatFileName)
%         sLongDataFileName=strcat(sBeatPathName,char(sBeatFileName{i}));
%         [aHeaderInfo aAllActivationTimes(:,:,i) aAllRepolarisationTimes(:,:,i) aAllAPDs(:,:,i)] = ReadOpticalDataCSVFile(sLongDataFileName,40,41,7);
%     end
% else
...
%     end
%     %get the beat data
%     [aHeaderInfo aAllActivationTimes aAllRepolarisationTimes aAllAPDs] = ReadOpticalDataCSVFile(strcat(sBeatPathName,sBeatFileName),40,41,7);
% end
