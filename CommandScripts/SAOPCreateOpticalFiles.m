...
oAvOptical = GetOpticalFromMATFile(Optical,'G:\PhD\Experiments\Auckland\InSituPrep\20140821\20140821CCh004\CCh004a_g10_LP100Hz-wave.mat');

% % % %read in all waveforms 
oEachOptical = GetOpticalFromMATFile(Optical,'G:\PhD\Experiments\Auckland\InSituPrep\20140821\20140821CCh004\CCh004a_g10_LP100Hz-waveEach.mat');

% % % % %name the folders files we want
aFolders = {...
    'G:\PhD\Experiments\Auckland\InSituPrep\20140821\20140821CCh003' ...
   };
% 
...
for i = 1:numel(aFolders)
    ...
    sType = 'CCh';
        ...
        sAvFileName = {...
            [aFolders{i},'\',sType,sRoot,'a_g10_LP100Hz-wave.csv'] ...
            [aFolders{i},'\',sType,sRoot,'b_g10_LP100Hz-wave.csv'] ...
            [aFolders{i},'\',sType,sRoot,'c_g10_LP100Hz-wave.csv'] ...
            };
        sEachFileName = {...
            [aFolders{i},'\',sType,sRoot,'a_g10_LP100Hz-waveEach.csv'] ...
