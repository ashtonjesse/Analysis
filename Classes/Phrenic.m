classdef Phrenic < BasePotential
    ...
    methods (Access = public)
        function ResampleData(oPhrenic, dNewFrequency, dOldFrequency)
            oPhrenic.Electrodes.(oPhrenic.Electrodes.Status).Data = oPhrenic.ResampleSignal(oPhrenic.Electrodes.(oPhrenic.Electrodes.Status).Data, dNewFrequency, dOldFrequency);
