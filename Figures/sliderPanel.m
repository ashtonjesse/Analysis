function [sliderHandle,panelHandle,editHandle] = sliderPanel(parent,PanelPVs,SliderPVs,EditPVs,LabelPVs,numFormat,...
    panelHandle,sliderHandle,editHandle,labelHandle,varargin)
